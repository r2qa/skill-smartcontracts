...
> Walk every applicable item during a review. Grouped by contract type. For each: the grep-able pattern, why it's risky, and the concrete check to perform. 175 function patterns across 21 contract-type categories. Companion: [vulnerable-chains.md](vulnerable-chains.md).
